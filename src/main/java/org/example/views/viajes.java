 ...
 * @author jorge
 */
public class viajes extends javax.swing.JDialog {

    /**
     * Creates new form viajes
     */
    public viajes(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Identificacion", "Marca", "Chofer", "Km/Lt"
            }
        ) {
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                viajes dialog = new viajes(new javax.swing.JFrame(), true);
