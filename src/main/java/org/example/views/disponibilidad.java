...
public class disponibilidad extends javax.swing.JDialog {
     ...
     */
    public disponibilidad(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                disponibilidad dialog = new disponibilidad(new javax.swing.JFrame(), true);
